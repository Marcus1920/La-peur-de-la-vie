...
<table id="captureContainer" border=0 cellpadding=4 cellspacing=0 style="font: 11pt 'Arial';color:#ffffff;border-collapse:collapse;border:1px solid #ffffff">
    ...
    <tr style="font: 11pt 'Arial';color:#ffffff">
		...
		<tr>
	        ...
	        <td class="">
	        	<input class="formField" id="street_number" type="text" name="street_number"  style="text-align:center" placeholder="Street Number"></input>
	        </td>
		...
		<tr>
	        ...
	        <td colspan="2">
	        	<input class="formField" id="route" name="route" type="text"  style="text-align:center" placeholder="Road"></input>
	        </td>
      	</tr>
      ...
      <tr>
	        ...
	        <td colspan="3">
	        	<input class="formField" id="locality" name="locality" type="text" style="text-align:center" placeholder="City"></input>
	        </td>
      </tr>

      <tr>
        <td class="">
        	<input class="formField" id="administrative_area_level_1" type="text" name="administrative_area_level_1"  style="text-align:center" placeholder="State"></input>
        </td>
       ...
       <tr>
        ...
        <td class="">
        	<input class="formField" id="postal_code" name="postal_code"  type="text"   style="text-align:center" placeholder="Zip code"></input>
        </td>
      </tr>
      <tr>
        
        <td class="" colspan="3">
        	<input class="formField" id="country"  style="text-align:center" placeholder="Country" type="text"></input>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td class="" colspan="3">
        	<input class="formField" id="client_reference_number"  style="text-align:center" placeholder="Client Reference Number" type="text"></input>
        </td>
      </tr>

      <tr>     
        <td class="" colspan="3">
        	<input class="formField" id="saps_station" style="text-align:center" placeholder="SAPS Station" type="text"></input>
        </td>
      </tr>
