                    ...
                    <table class="table table-hover table-bordered results" id="myPrivateTable" >
                        ...
                        @foreach($contactBook as $privateContact)
                            <tr class="clickable-private">
                                <td>
                                    <input type="checkbox" name="row" value="{{$privateContact->user_id}}" class="removeContacts" id="id"></td>
                ...
                <form class="form-horizontal" role="form" id="profileForm">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group col-md-18">
                            ...
                            <div class="col-sm-10">
                                <input type="first_name" class="form-control" id="name" readonly value="{{$privateContact->user->name}}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10" >
                                <input type="Surname" class="form-control" id="surname"  value="{{$privateContact->user->surname}}"readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="dob" class="form-control" id="dob_private"  value="{{$privateContact->user->dob}}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="email" class="form-control" id="email_address"  value="{{$privateContact->user->email}}" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-2 control-label">
                            ...
                            <div class="col-sm-10">
                                <input type="cellphone" class="form-control" id="cellphone" value="{{$privateContact->user->cellphone}}" readonly >
                            </div>
                        </div>
