...
?>
<div class="fieldTemplate clearfix" style="/*border-bottom: 2px dashed green;*/ border: 1px dashed #464646; display: none; margin: 5px 20px; /*padding: 15px 0*/">
	<div class="wHeader">
		<div class="wSort">
	...
	<div style="clear: both">
		<div style="" class="col-md-6">
			<div>
				...
				{!! Form::text('field['.$index.'][order]',isset($field) ? $field['order'] : NULL,['class' => 'form-control input-sm','id' => 'fieldOrder', 'style'=>"width: 5em; display: initial; height: initial; margin: 0; padding: 0"]) !!}
			</div>
				...
				<div class="optsRelated" style="clear: both; margin-left: 1em;">
					...
					<div style="border: 1px solid rgba(255, 255, 255, 0.3); margin-top: 0.5em">
						...
						<div class="wLoader" style="display: none; position: absolute; top: 50%; left: 50%;">
							{{--<h1>Loading AJAX</h1>--}}
							<img src="{{ asset("/img/media-player/loading.gif") }}" style="width: 50%">
						</div>
					</div>
				</div>
			</div>
		...
		<div class="wInputs" style="clear: both">
			{!! Form::label('lblInputs', 'Inputs', array('class' => 'col-md-2 control-label', 'style'=>"float: none")) !!}
		</div>
	</div>
	<hr style="clear: both; float: none; margin: 0.5em auto 0.125em auto; text-align: center; width: 85%" />
</div>
