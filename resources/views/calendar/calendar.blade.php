...
<div class="form-group" style="float: right;margin-right:2%;"><div class="btn-sm m-t-10"  style="margin-top: 20px; height:25px; width: 75px; background-color: #4caf50;"></div><label style="float: left;">Active Cases</label></div>
