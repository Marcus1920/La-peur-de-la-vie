            ...
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 bhoechie-tab-menu">
                <div class="list-group">
                    <a href="#" class="list-group-item active text-center">
                        <h5 class="glyphicon glyphicon-plane"></h5><br/>Flight
                    </a>
                    <a href="#" class="list-group-item text-center">
                        <h5 class="glyphicon glyphicon-road"></h5><br/>Train
                    </a>
                    <a href="#" class="list-group-item text-center">
                        <h5 class="glyphicon glyphicon-home"></h5><br/>Hotel
                    </a>
                    <a href="#" class="list-group-item text-center">
                        <h5 class="glyphicon glyphicon-cutlery"></h5><br/>Restaurant
                    </a>
                    <a href="#" class="list-group-item text-center">
