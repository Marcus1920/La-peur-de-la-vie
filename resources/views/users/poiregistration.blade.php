...
<div class="block-area">
                ...
                <h3 class="block-title">POI PERSONAL DETAILS</h3><br>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                @if ($errors->has('profile_pic_note')) <p class="help-block red">*{{ $errors->first('profile_pic_note') }}</p> @endif
                       ...
                       <div class="col-md-4">
                        ...
                        <div class="row">
                             <div class="col-md-4">
                                ...
                                {!! Form::select('religion',$selectReligions,0,['class' => 'form-control input-sm m-b-10' ,'id' => 'religion']) !!}
                             ...
                             <div class="col-md-4">
                                ...
                                {!! Form::select('qualification_type',$selectQualificationTypes,0,['class' => 'form-control input-sm m-b-10' ,'id' => 'qualification_type']) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4  @if ($errors->has('id_number')) @else  hidden @endif idnumber">
                                ...
                                {!! Form::text('id_number',NULL,['class' => 'form-control input-sm m-b-10','id' => 'id_number']) !!}
                                 <p class="showIdNumber help-block red hidden">*The selected Id number is invalid.</p>
                            ...
                            <div class="col-md-4">
                                ...
                                <input data-format="yyyy-MM-dd" type="text" name="doc_expiry_date" class="form-control input-sm m-b-10" />
                                <span class="add-on">
                                <i class="sa-plus"></i>
                                </span>
                                </div>
                            ...
                            <div class="col-md-4 hidden passportnumber">
                                ...
                                {!! Form::text('work_permit',NULL,['class' => 'form-control input-sm m-b-10','id' => 'work_permit']) !!}
                            ...
                            <div class="col-md-4 hidden passportnumber">
                                ...
                                <div class="input-icon datetime-pick date-only">
                                <input data-format="yyyy-MM-dd" type="text" name="work_permit_expiry_date" class="form-control input-sm m-b-10" />
                                <span class="add-on">
                                <i class="sa-plus"></i>
                                </span>
                                </div>
                            ...
                            <div class="col-md-4 hidden passportnumber">
                                ...
                                {!! Form::text('yellow_fever',NULL,['class' => 'form-control input-sm m-b-10','id' => 'yellow_fever']) !!}
                            ...
                            <div class="col-md-4 hidden passportnumber">
                                ...
                                <div class="input-icon datetime-pick date-only">
                                <input data-format="yyyy-MM-dd" type="text" name="yellow_fever_expiry_date" class="form-control input-sm m-b-10" />
                                <span class="add-on">
                                <i class="sa-plus"></i>
                                </span>
                                </div>
                            ...
                            <div class="block-area" id="inline">
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                      {!! Form::label('Residential Location', 'Residential Location', array('class' => 'col-md-3 control-label')) !!}
                            ...
                            <div class="block-area" id="inline">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                      ...
                                      {!! Form::text('notice_period',NULL,['class' => 'form-control input-sm m-b-10','id' => 'notice_period']) !!}
    ...
    <div class="">
        ...
        <div class="form-group">
                <div class="col-md-4">
                    <button id="submitPoiForm" type="submit"class="btn btn-info  m-t-10">SAVE FORM</button>
                </div>
        </div>
...
function generate_banking_details_html(val) {
   ...
   $("#poiCaptureForm #id_number").on("blur",function(){

       var id_number =$("#id_number").val();

       if(!isValidSAID(id_number)) {

           $(".showIdNumber").removeClass("hidden");
           $("#submitPoiForm").prop('disabled',true);
       }else {

           $(".showIdNumber").addClass("hidden");
           $("#submitPoiForm").prop('disabled',false);
